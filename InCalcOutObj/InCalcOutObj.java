//********************************************************************
//  InCalcOutObj.java       Author: Greg Scott
//  Program calculates how many months old you are after prompting you
//  for your name and age. 
//  Demonstrates the use of the Person Object in the Main class 
//  of InCalcOut2.java
...
public class InCalcOutObj 
{
   ...
   // Round the output to three decimal places
      ...
      System.out.println (name + " you are " + fmt.format(p1.getMonths()) + " months old.");
   }
   //-----------------------------------------------------------------

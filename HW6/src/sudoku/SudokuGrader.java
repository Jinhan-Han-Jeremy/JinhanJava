...
public class SudokuGrader {
	...
	private enum Category {
		...
		// Grid evaluation
		Grid(45), next9Grids(15), isLegal(10), isFull(10), equals(10),
		// Solver evaluation
		evaluate(10), Solver(35),
		// Comments and style
		Style(5), Comments(5);
	...
	public void gradeGrid() {
		...
		String[] puzzleTestEqual = { "..3.1.5..", "8..395..1", "14.....27", ".8..7..5.", "62.9.4.13", ".9..2..7.",
				"91.....34", "2..748..9", "..6.3.2.." };
		...
		String[] puzzleTestisLegalRow = { "..3.3.5..", "8..395..1", "14.....27", ".8..7..5.", "62.9.4.13", ".9..2..7.",
				"91.....34", "2..748..9", "..6.3.2.." };
		String[] puzzleTestisLegalCol = { "..3.1.5..", "8..395..1", "14.....27", ".8..7..5.", "62.9.4.13", ".9..2..7.",
				"91.....34", "2..748..9", "8.6.3.2.." };
		if (!g1.isLegal()) {
		...
		// check for isFull
		String[] testisFull = { "463217598", "872395641", "159486327", "384671952", "627954813", "591823476",
				"918562734", "235748169", "746139285" };
		if (g1.isFull()) {
	...
	public void gradeSolver() {
		...
		String[] puzzleTestisLegalCol = { "..3.1.5..", "8..395..1", "14.....27", ".8..7..5.", "62.9.4.13", ".9..2..7.",
				"91.....34", "8..748..9", "..6.3.2.." };
		String[] puzzleTestisLegalGrid = { "3.3.1.5..", "8..395..1", "14.....27", ".8..7..5.", "62.9.4.13", ".9..2..7.",
				"91.....34", "8..748..9", "..6.3.2.." };
		...
		try {
			...
			if (s.evaluate(g2) != Evaluation.ABANDON || s.evaluate(g3) != Evaluation.ABANDON
					|| s.evaluate(g4) != Evaluation.ABANDON) {

...
public class DieRollPanel extends JPanel
{
   ...
   public static String url = "file:C:/student/Diroll/one1.wav";
   ...
   private class DieRollListener implements ActionListener
   {
      ...
      public void actionPerformed (ActionEvent event)
      {
         ...
         if (x==moveX)
         {
             try
             {
                      PlaySound.myPlay("file:C:/student/Diroll/rolldie.wav");
                      soundFlag = false;
             }
         ...
         if (x < WIDTH-IMAGE_SIZE)
         ...
         else
           {
              ...
              repaint(); 
              // url is or soundfile to match the last image displayed
               try
                {
